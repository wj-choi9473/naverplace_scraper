...
class Mydriver:
    ...
    def cafe_scraper(self, cafename):
        ...
        self.driver.get(url)
        btn1 = self.driver.find_element_by_css_selector("""#ct > div.search_listview._content._ctList > ul > li:nth-child(1) > div.item_info > a.a_item.a_item_distance._linkSiteview > div""")
        btn1.click()
